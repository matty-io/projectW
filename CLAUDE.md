...
Claude sessions in either sub-repo (CLAUDE.md is read from the cwd and every parent dir).
Repo-specific build commands, patterns, and tooling live in each repo's own `CLAUDE.md`.
